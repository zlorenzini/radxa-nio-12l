...
typedef enum {
    N = 0,  ///< Batch dimension index.
    H = 1,  ///< Height dimension index.
    W = 2,  ///< Width dimension index.
    C = 3,  ///< Channel dimension index.
    Invalid = C + 1,
    DimensionSize = Invalid,  ///< Dimension size.
} RuntimeAPIDimIndex;
...
typedef struct {
    uint32_t dimensions[DimensionSize];
